            ...
            <div className="flex flex-col gap-2 lg:gap-4">
              ...
              <div className="flex flex-col gap-1">
                <h2 className="text-violet-600 font-semibold text-2xl sm:text-3xl lg:text-3xl">
                  Collaborated with Various Events
                </h2>
                <p className="text-white text-[10px] sm:text-xs lg:text-xs">
                  We&apos;ve partnered with leading global events like DEVCON,
                  WebX 2024, DAO Tokyo, and many more, driving innovation in
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2 lg:gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-white text-[10px] sm:text-xs lg:text-xs">
                    These numbers reflect our expanding influence, global reach,
                    and the trust we&apos;ve built within the community and
                    industry.
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 max-sm:gap-3 w-full">
          ...
          <div className="rounded-xl flex flex-col gap-2 md:gap-4 border border-[#2c2c2c] p-3 sm:rounded-2xl sm:p-3 lg:rounded-3xl lg:p-6 w-full lg:w-1/3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-white text-[10px] sm:text-xs lg:text-xs">
                With a presence in 5+ countries, we’re driving innovation in
                decentralized technologies and shaping the future of the digital
                world.
              </p>
            </div>
          </div>
